# Guildhall Factory Detector Reviewer report — dispatch 001

**Disposition:** blocked by **17 unresolved blocking findings**. This is an acceptance-instrument review only. It is not a product verdict and does not claim the Guildhall concept proven or disproven.
...
- [`tests/conftest.py:87–99`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:87) always calls `verify_manifest()`.
- [`tests/acceptance/_harness/requirements.py:201–227`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/_harness/requirements.py:201) reads the excluded evidence and receipt paths named by [`spec/ratification-manifest.json:39–46`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/spec/ratification-manifest.json:39).
- [`tests/run-acceptance.sh:34–42`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/run-acceptance.sh:34) may also create `tests/.venv` and install dependencies from the network.
...
| V-5 | Nine independently planted event histories | Empty initialized repository plus `GUILDHALL_ACCEPTANCE_TEMPORAL_CASE` | Direct result selector |
...
| V-7 | Candidate records ingested through the shipping corpus surface | Empty repository plus `GUILDHALL_ACCEPTANCE_V7_FIXTURE=1` | Direct work substitute |
...
The governing catalog rule is [`spec/verification.md:118–133`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/spec/verification.md:118): each gate must freeze its threshold, positive control, negative control, and detector mutation, with unresolved findings blocking combination.
...
| **V-5** | Nine frozen cases `T5:206`; nine counterfactuals `T5:242`; newest/authority/repetition cases `T5:281,307,331,365`; runtime and unregistered environment `T5:399,433`. Authority: `V:370–388`. | No formal V-5 controls. The table is both the test oracle and, via case ID, an input to the SUT. | Three V-5 mutations at `MUT:352–380`. | **Missing.** | No event histories establish any case. Holding repository state fixed and changing `GUILDHALL_ACCEPTANCE_TEMPORAL_CASE` selects semantic output. **Non-independent.** |
...
Every `GUILDHALL_ACCEPTANCE_*` name also discloses acceptance-run identity to the SUT even where the “answer bits” column says the value itself contains no semantic answer.

### `GUILDHALL_ACCEPTANCE_*` controls
...
|---|---|---|---|---|
| `GUILDHALL_ACCEPT_DETECTOR_MUTATION` — `DET:37,50–59`; `C:118,227` | Detector selection/reporting | `result_selector` | Conveys mutant identity and changes detector behavior | H; selection recorded, kill not enforced |
| `GUILDHALL_ACCEPT_MUTATION` — `MUT:37,58–66`; `C:111,226` | Product-mutation selector | `result_selector` | Conveys expected mutation ID but does not apply it | H; header/output only |
| `GUILDHALL_ACCEPT_GATE_VECTOR` — `C:217–235` | Output path | `environment` | No answer bits or work substitution | H; artifact sink |
| `GUILDHALL_BIN` — `CLI:255–278` | SUT executable | `environment` | No answer bits | H→shipping entrypoint; existence/exit would witness execution |
| `GUILDHALL_SPEC_ROOT` — `REQ:118–137` | Authority root | `environment` | No answer bits | H; manifest digest checked, but verification crosses excluded evidence |
| `GUILDHALL_TESTER_VAULT` — `tests/acceptance/_harness/vault.py:44,111–135` | Canary custody | `environment` | No answer bits | H; location/mode/worktree checks are substantive |
| `GUILDHALL_HOST_CODEX`, `GUILDHALL_HOST_CLAUDE` — `tests/acceptance/_harness/hosts.py:91–114` | Host executable selection | `environment` | No semantic answer bits | H/P; `--version` is read, but actual hook invocation is not mandatory |
| `GUILDHALL_CLASSIFIER_PROVIDER` — `T3P:673` | V-3 egress denial | `environment` | Names the forbidden provider | P/U; no real private event or outbound attempt is witnessed |
| `GUILDHALL_COMPANY_URL` — occurrences listed at `T2:536,685`, `T3Q:330`, `T6:153–621`, `T8:167–807`, `T9H:539,582`, `NF:245` | Live/dead/blackholed Company endpoint | `environment` | No answer bits | P/C where a server/blackhole is independently started; P/U elsewhere |
| `GUILDHALL_PROOF_CLOCK_OFFSET_SECONDS` — `T2:634`, `T8:747`, `NF:510` | Expiry schedule | `fault_schedule` | Timing only | P/U; no independently witnessed clock receipt or actual prerequisite state |
...
1. The V-2 runtime JSONL is built with `{**record, "text": text}` at [`test_v2_classification.py:91–101`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v2_classification.py:91). Each `record` contains `gold_atoms`, `mixed`, and `stratum`; [`routing_corpus.json:3723–3762`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/fixtures/gold/routing_corpus.json:3723) shows expected atoms/destinations adjacent to message text. That same JSONL is passed to `session observe` at `T2:216–223`, `318–325`, `360–367`, `404–411`, and `445–452`.

2. V-5 gives the SUT the exact table row ID at [`test_v5_temporal.py:161–183`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v5_temporal.py:161), while expected state/fragments are defined at lines 59–150.

3. V-7 supplies `GUILDHALL_ACCEPTANCE_V7_FIXTURE=1` from an otherwise empty repository at [`test_v7_projection.py:82–114`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v7_projection.py:82).
...
The only auxiliary file is [`tests/fixtures/policies/auxiliary-corpus-request.json`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/fixtures/policies/auxiliary-corpus-request.json:1). It describes eligibility classes and says at line 48 that it is only a request and recording contract.
...
- **Locations:** [`tests/conftest.py:87–99`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:87), [`requirements.py:201–227`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/_harness/requirements.py:201), [`run-acceptance.sh:34–42`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/run-acceptance.sh:34).
...
- **Locations:** [`tests/conftest.py:100`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:100), [`tests/conftest.py:196–203`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:196), [`tests/conftest.py:206–235`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:206).
...
- **Location:** [`tests/conftest.py:179–183`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:179).
- **Violated spec:** [`spec/verification.md:34–36`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/spec/verification.md:34).
...
- **Locations:** [`mutations.py:1–14`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/_harness/mutations.py:1), [`test_backreference_integrity.py:170–192`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_backreference_integrity.py:170), [`ACCEPTANCE-MAP.md:52–86`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/ACCEPTANCE-MAP.md:52).
...
- **Locations:** [`mutations.py:58–66`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/_harness/mutations.py:58), [`tests/conftest.py:111–120`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/conftest.py:111), [`test_harness_selftest.py:361–480`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_harness_selftest.py:361).
- **Violated spec:** `V:120–126`; `TM:157–162`.
- **Counterexample:** set `GUILDHALL_ACCEPT_MUTATION=v5.newest_wins`; no code applies that mutation or checks its nodes. Five detector entries point to a self-test that intentionally passes when the mutant is blind.
...
- **Locations:** [`test_v2_classification.py:91–101`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v2_classification.py:91), [`routing_corpus.json:3723–3762`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/fixtures/gold/routing_corpus.json:3723), [`test_v5_temporal.py:161–183`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v5_temporal.py:161), [`test_v7_projection.py:90–114`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v7_projection.py:90), [`test_v9_fatigue.py:483–537`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v9_fatigue.py:483).
...
- **Locations:** [`test_v1_ingestion.py:324–353`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v1_ingestion.py:324), [`test_v1_ingestion.py:458–502`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v1_ingestion.py:458).
...
- **Locations:** [`routing_corpus.json:1601–1602`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/fixtures/gold/routing_corpus.json:1601), [`test_v2_classification.py:213–299`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v2_classification.py:213), [`test_v2_classification.py:502–654`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v2_classification.py:502), [`test_v2_classification.py:717–755`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v2_classification.py:717).
...
- **Locations:** [`scanners.py:60–90`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/_harness/scanners.py:60), [`test_v3_attacks.py:91–135`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v3_attacks.py:91), [`test_v3_privacy.py:145–259`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v3_privacy.py:145), [`test_v3_qualification.py:82–159`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v3_qualification.py:82).
...
- **Locations:** [`test_v4_maintenance.py:95–126`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v4_maintenance.py:95), [`test_v4_maintenance.py:227–268`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v4_maintenance.py:227), [`test_v4_maintenance.py:354–379`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v4_maintenance.py:354), [`test_v4_maintenance.py:439–643`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v4_maintenance.py:439).
...
- **Locations:** [`test_v5_temporal.py:59–150`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v5_temporal.py:59), [`test_v5_temporal.py:153–183`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v5_temporal.py:153).
- **Violated spec:** `V:370–388`.
- **Counterexample:** all nine cases use the same empty initialized repository; changing only `GUILDHALL_ACCEPTANCE_TEMPORAL_CASE` changes the asserted state, fragment, and counterfactual.
...
- **Locations:** [`test_v6_authority.py:50–130`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v6_authority.py:50), [`test_v6_authority.py:146–180`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v6_authority.py:146), [`test_v6_authority.py:205–264`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v6_authority.py:205), [`test_v6_authority.py:510–598`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v6_authority.py:510).
...
- **Location:** [`test_v7_projection.py:82–114`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v7_projection.py:82).
- **Violated spec:** `V:421–436`.
- **Counterexample:** an implementation can detect `GUILDHALL_ACCEPTANCE_V7_FIXTURE=1` and emit the exact roles, selection trace, and stopping reason expected by the tests.
...
- **Locations:** [`test_v8_company_refs.py:74–114`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v8_company_refs.py:74), [`test_v8_company_refs.py:135–191`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v8_company_refs.py:135), [`test_v8_company_refs.py:260–305`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v8_company_refs.py:260), [`test_v8_company_refs.py:464–548`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v8_company_refs.py:464), [`test_v8_company_refs.py:696–834`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v8_company_refs.py:696).
...
- **Locations:** [`test_v9_host_lifecycle.py:114–165`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v9_host_lifecycle.py:114), [`test_v9_host_lifecycle.py:190–308`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v9_host_lifecycle.py:190), [`test_v9_host_lifecycle.py:462–617`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v9_host_lifecycle.py:462), [`test_v9_fatigue.py:87–141`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v9_fatigue.py:87), [`test_v9_fatigue.py:421–537`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v9_fatigue.py:421).
...
- **Locations:** [`auxiliary-corpus-request.json:1–49`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/fixtures/policies/auxiliary-corpus-request.json:1), [`test_v3_qualification.py:598–629`](/Users/jmcentire/Code/guildhall-proof-lanes-ac8a13d1/detector-reviewer/tests/acceptance/test_v3_qualification.py:598).
